    ...
    <nav className="   top-0 fixed w-full z-10 bg-white shadow-md">
      <div className="  flex flex-wrap items-center justify-between mx-auto px-4 py-2">
        <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <Image src="/logo.png" width={200} height={200} className="h-16 w-16 rounded-full" alt="logo" />
          <span className="self-center md:text-2xl text-xl    whitespace-nowrap text-[#f15a24] tracking-tighter ">Business website</span>
        </Link>
        <Button
          onClick={toggleMenu}
           className='md:hidden'
